      ...
      <section id="resume" style={{backgroundColor:"rgb(43 127 139)",boxShadow: "5px 10px"}}>
        ...
        <Slide left duration={3000}>
          <div className="row">
            ...
            <div className="twelve columns main-col" style={{ textAlign: "justify", color: "#fff", fontSize: "17px"}}>
              ...
              <div className="six columns main-col">
                ...
                <center><u><span style={{color : "#fff", fontSize: "17px"}}>1. Technology Consulting</span></u></center>
                <div style={{ textAlign: "left", color: "#fff", fontSize: "17px"}}>
              ...
              <div className="six columns main-col">
                ...
                <center><u><span style={{color : "#fff", fontSize: "17px"}}>2. Big Data Solutions</span></u></center>
                <div style={{ textAlign: "left", color: "#fff", fontSize: "17px"}}>
                <ReactReadMoreReadLess
                  className="readMoreReadLessClass"
                  charLimit={100}
              ...
              <div className="six columns main-col">
                ...
                <center><u><span style={{color : "#fff", fontSize: "17px"}}>3. Cloud Computing Consulting</span></u></center>
                <div style={{ textAlign: "left", color: "#fff", fontSize: "17px"}}>
                <ReactReadMoreReadLess
                  className="readMoreReadLessClass"
                  charLimit={100}
              ...
              <div className="six columns main-col">
                ...
                <center><u><span style={{color : "#fff", fontSize: "17px"}}>4. IT Staffing linked Augmentation Solution</span></u></center>
                <div style={{ textAlign: "left", color: "#fff", fontSize: "17px"}}>
                <ReactReadMoreReadLess
                  className="readMoreReadLessClass"
                  charLimit={100}
